    ...
    while True:
        ...
        if up >= 0:
            ...
            if up_diff_count <= 1:
                ...
                if validate_reflection(up+1, map, "H", can_be_fixed=up_diff_count==1):
                    return (up+1) * 100
        ...
        if down < len(map):
            ...
            if down_diff_count <= 1:
                ...
                if validate_reflection(down, map, "H", can_be_fixed=down_diff_count==1):
                    return down * 100
...
def scan_vertically(map):
    ...
    while True:
        ...
        for y in range(len(map)):
            ...
            if not left_is_reflection and not left_can_be_fixed and not right_is_reflection and not right_can_be_fixed:
                break
        ...
        if right_is_reflection or right_can_be_fixed:
            print('right found candidate reflection vertically', right) ##TODO might be sometjing wrong here?
